...
from apps.dashboard.forms import UserUpdateForm
...
def account_view(request):
    ...
    context = {'form': form}
    return render(request, 'app/platform/account/me/page.html', context)
...
def settings_view(request):
    ...
    return render(request, 'app/platform/account/settings/page.html', context)